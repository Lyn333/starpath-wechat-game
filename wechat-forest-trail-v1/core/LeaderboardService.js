...
class LeaderboardService {
  ...
  async initialize() {
    ...
    try { api.cloud.init({ env: CLOUD_ENV, traceUser: true }); this.cloudReady = true; this.rankings.global = { state: "ready", text: "总榜将在通关后同步" }; return true; }
...
module.exports = { CLOUD_ENV, FRIEND_SCORE_KEY, LeaderboardService };
